...
// Initialize mobile menu functionality
        function initializeMobileMenu() {
            ...
            const mobileMenuCta = document.querySelectorAll('.mobile-menu-cta');
            const mobileMenuCtaButton = document.querySelectorAll('.mobile-menu-cta a');
            ...
            function openMobileMenu() {
                ...
                // Animate CTA button(s)
                if (mobileMenuCta && mobileMenuCta.length > 0) {
                    mobileMenuCta.forEach(cta => {
            ...
            // Close menu when clicking on CTA button(s)
            if (mobileMenuCtaButton && mobileMenuCtaButton.length > 0) {
                mobileMenuCtaButton.forEach(btn => {
